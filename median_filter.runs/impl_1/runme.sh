...
HD_PWD='C:/Toma/vlsi/median_filter/median_filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log median_filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source median_filter.tcl -notrace
