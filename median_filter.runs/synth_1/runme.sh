...
HD_PWD='C:/Toma/vlsi/median_filter/median_filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log median_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source median_filter.tcl
